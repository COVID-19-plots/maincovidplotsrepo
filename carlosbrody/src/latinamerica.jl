...
plotGrowth(vcat(la, ["Italy", "World other than China"]), days_previous=days_previous,
...
plotNew(vcat(la, allLA), fignum=17, fname="laNew", maxtic=40000,
   minval=1, mintic=1, days_previous=days_previous)
plotNew(la, db=D, minval=1, mintic=1, maxtic = 1000,
   counttype="deaths", fname="laNewDeaths", days_previous=days_previous)
